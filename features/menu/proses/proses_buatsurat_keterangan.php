...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $kop_surat_path = "../assets/images/kop_surat/kopsurat.jpg";
    ...
    $pdf_filename = "Keterangan_" . str_replace(['/', '\\'], '-', $nomor_surat) . ".pdf";
    ...
    // mysqli_stmt_bind_param($stmt_insert, "sssssss", $tanggal, $nomor_surat, ..., $pdf_filename);
